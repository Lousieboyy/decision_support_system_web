  ...
  useEffect(() => {
    ...
    const tryApply = (attempt = 0) => {
      ...
      try {
        ...
        // which — since Melaka's box is wider than it is tall and these
        // containers are closer to square — zoomed out far enough to fit
        // the wide axis while leaving the taller axis with room to spare,
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="content-card-header flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-[#1f1e1a]/8 pb-4">
              ...
              <div className="flex bg-[#f5f1e6] p-1 rounded-xl border border-[#1f1e1a]/8 self-start sm:self-auto">
                ...
                >
                  Systemic ({resolvedSystemicAdvisories.length})
                </button>
              </div>
            </div>
